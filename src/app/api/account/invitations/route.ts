...
import { getBaseUrl as resolveBaseUrl } from "@/lib/http/base-url";

// Thin wrapper: fixes the log prefix for this route. See
// src/lib/http/base-url.ts for the full resolution-order doc comment
// (shared with the Google OAuth routes, which need the same "what's
// my public URL" logic to build a correct redirect_uri).
function getBaseUrl(request: Request): string {
  return resolveBaseUrl(request, "[POST /api/account/invitations]");
}
